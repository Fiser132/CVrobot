...
export default function Blog() {
  ...
  return (
    <section className="bg-orange-50 py-16">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 md:gap-14">
        {articles.map((article, i) => (
          <div key={i} className="flex gap-6 md:gap-10 max-h-[90px] md:max-h-[180px] items-start w-full md:w-[610px]">
            <img
              src={article.image}
              alt={article.title}
