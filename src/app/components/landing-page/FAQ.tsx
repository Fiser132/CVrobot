...
export default function FAQ() {
  const questions = [
    {
      ...
      answer: "Přes náš formulář odešlete svá data ke zpracování online a to již během pár minut. Náš generátor zpracuje všechny vyplněné údaje a vytvoří Vám ihned profesionální PDF a HTML vzory životopisu aktuální pro rok 2024."
    },
    {
  ...
  return (
    <section className="py-20 px-4 lg:px-52">
 ...
 >
   <div className="">
     <div className="flex justify-between items-center bg-[#F7F7F7] p-4 rounded-xl">
       ...
       <FontAwesomeIcon icon={openIndex === i ? faMinus : faPlus} className="text-primary h-5" />
     </div>
