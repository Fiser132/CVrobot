export default function Steps() {
  ...
  return (
    <section className="bg-white py-32">
      <div className="container mx-auto px-4 flex flex-col md:flex-row w-full justify-around">
        {steps.map((step, i) => (
          <div key={i} className="relative flex items-center gap-2 md:gap-0 w-full">
           <div className="relative w-[200px]">
            ...
            <img src={step.icon} alt="" className="w-[80px] h-[80px] md:w-[100px] md:h-[100px] mb-3 absolute md:top-14 md:left-15 top-12 left-12" />
            </div>
            <div className="flex flex-col max-w-[240px] w-full gap-3">
              <h3 className="text-[24px] md:text-[28px] text-secondary font-dm-serif">{step.title}</h3>
